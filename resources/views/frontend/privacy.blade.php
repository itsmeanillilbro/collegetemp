...
@section('main-container')
    ...
    <div class="all-title-box">
        <div class="container text-center">
            <h1>Privacy Policy<span class="m_1"><a href="{{ url('/') }}">Home</a> / <a
                        href="{{ url('/privacy') }}">Privacy Policy</a></span></h1>
        </div>
    </div>
    <!-- Breadcrumb End -->
    <div class="privacy container mt-5">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                    or &quot;Our&quot; in this Agreement) refers to peoplescampus.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to peoplescampus, accessible from <a href="https://peoplescampus.edu.np/"
                        rel="external nofollow noopener" target="_blank">https://peoplescampus.edu.np/</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>By email: info@peoplescampus.edu.np</li>
        </ul>
    </div>
@endsection
